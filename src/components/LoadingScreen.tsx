  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        <div className="loading-card rounded-[2rem] border border-white/10 bg-white/10 px-8 py-10 shadow-[0_0_80px_rgba(255,107,0,0.16)] backdrop-blur-2xl">
          ...
          <div className="loading-bar mx-auto mt-8 h-1.5 w-64 overflow-hidden rounded-full bg-white/10">
            <div
