      ...
      <ScrollReveal className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-3">
          {plans.map((plan) => (
            <AnimatedCard
              key={plan.name}
              className={`pricing-card rounded-[1.75rem] border p-8 shadow-[0_0_60px_rgba(0,0,0,0.28)] backdrop-blur-xl transition duration-300 hover:shadow-[0_0_50px_rgba(255,107,0,0.14)] ${
                plan.featured
