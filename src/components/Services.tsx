      ...
      <ScrollReveal className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-3">
          {services.map((service) => (
            <AnimatedCard
              key={service.title}
              className="rounded-[1.75rem] border border-white/10 bg-white/10 p-8 shadow-[0_0_60px_rgba(0,0,0,0.28)] backdrop-blur-xl transition duration-300 hover:border-[#ff6b00]/30 hover:shadow-[0_0_50px_rgba(255,107,0,0.16)]"
            >
